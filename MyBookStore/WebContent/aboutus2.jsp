	...
	<div id="header" class="shell">
		...
		<div id="navigation">
			<ul>
				...
				<li><a href="NewFile.jsp">Profile</a></li>
		...
		<div id="login-details">
			...
			%><p>Welcome, <a href="#" id="user"><%=u.getUsername()%></a> .</p><p><a href="#" class="cart" ><img src="css/images/cart-icon.png" alt="" /></a>Shopping Cart (0) <a href="#" class="sum">$0.00</a></p>
		</div>
		<!-- End Login-details -->
	</div>
	<!-- End Header -->
