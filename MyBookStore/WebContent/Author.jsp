  ...
  //String name= request.getAttribute("Name");
	...
	<div id="header" class="shell">
		...
		<div id="login-details">
			...
			<p>Welcome, <a href="#" id="user"><%=username%></a> .</p><p><a href="#" class="cart" ><img src="css/images/cart-icon.png" alt="" /></a>Shopping Cart (0) <a href="#" class="sum">$0.00</a></p>
		...
		<div id="sidebar">
			<ul class="categories">
				...
				<li>
					...
					<ul>
						<form action="Author">
						Author: <input type="text" name="author" value="Chetan Bhagat"><br>
